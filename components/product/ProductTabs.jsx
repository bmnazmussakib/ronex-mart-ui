    ...
    <div className="bg-white rounded-lg border border-slate-200/90  overflow-hidden">
      ...
      <div className="flex items-center border-b border-slate-200 bg-slate-50 px-2 pt-2 overflow-x-auto gap-1 custom-scrollbar">
        <button
          ...
          className={`px-3.5 py-2.5 text-md font-semibold transition-all border-b-2 cursor-pointer whitespace-nowrap ${activeTab === 'description'
        ...
        <button
          ...
          className={`px-3.5 py-2.5 text-md font-semibold transition-all border-b-2 cursor-pointer whitespace-nowrap ${activeTab === 'specifications'
              ? 'border-[#006a52] text-[#006a52] bg-white rounded-t-lg shadow-2xs'
              : 'border-transparent text-slate-600 hover:text-slate-900'
            }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2.5 text-md font-semibold transition-all border-b-2 cursor-pointer whitespace-nowrap ${activeTab === 'reviews'
              ? 'border-[#006a52] text-[#006a52] bg-white rounded-t-lg shadow-2xs'
              : 'border-transparent text-slate-600 hover:text-slate-900'
            }`}
        >
      ...
      <div className="p-5 text-xs text-slate-700 leading-relaxed">
        {activeTab === 'description' && (
          <div className="space-y-4">
            ...
            <p className='text-sm font-base text-slate-600'>
            ...
            <ul className="list-disc pl-5 space-y-1.5 font-base text-slate-600 text-sm">
        ...
        {activeTab === 'specifications' && (
          <div className="space-y-3">
            ...
            <div className="divide-y divide-slate-100 max-w-lg text-sm">
              <div className="py-2 grid grid-cols-2">
                <span className="font-medium text-slate-500">Brand</span>
                <span className="font-base text-slate-800">Unilever Bangladesh</span>
              </div>
              <div className="py-2 grid grid-cols-2">
                <span className="font-medium text-slate-500">Pack Weight</span>
                <span className="font-base text-slate-800">500 g</span>
              </div>
              <div className="py-2 grid grid-cols-2">
                <span className="font-medium text-slate-500">Form</span>
                <span className="font-base text-slate-800">Detergent Powder</span>
              </div>
              <div className="py-2 grid grid-cols-2">
                <span className="font-medium text-slate-500">Country of Origin</span>
                <span className="font-base text-slate-800">Bangladesh</span>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'reviews' && (
          <div id="reviews" className="space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                <h3 className="text-sm font-semibold text-slate-900">Customer Ratings</h3>
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-xl font-semibold text-slate-900">4.8</span>
              ...
              <button className="bg-[#006a52] text-white px-4 py-2 rounded-full text-xs font-semibold hover:bg-[#005240] transition-colors cursor-pointer">
                Write a Review
              </button>
            </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-lg border border-slate-100">
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-slate-900">Tanvir Ahmed</span>
