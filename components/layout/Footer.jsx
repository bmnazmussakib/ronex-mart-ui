          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {valueProps.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex items-center gap-3.5 p-3.5 rounded-lg bg-emerald-950/40 border border-emerald-900/40 hover:border-emerald-700/50 transition-all group"
                >
                  <div className="w-10 h-10 rounded-md bg-emerald-900/60 text-emerald-400 flex items-center justify-center text-lg shrink-0 group-hover:bg-[#006a52] group-hover:text-white transition-colors">
                    <IconComp />
                  </div>
                  <div>
                    <h4 className="text-md font-medium text-white leading-snug">{item.title}</h4>
                    <p className="text-xs text-emerald-100/60 font-medium">{item.subtitle}</p>
                  </div>
                </div>
              );
            })}
      ...
      <div className="w-full px-6 sm:px-8 pt-10 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-10 border-b border-emerald-900/60">
          ...
          <div className="lg:col-span-2 space-y-4 pr-0 lg:pr-6">
            ...
            <p className="text-sm text-emerald-100/70 leading-relaxed max-w-sm font-medium">
            ...
            <div className="space-y-2.5 text-sm text-slate-300 pt-1 font-medium">
              <div className="flex items-start gap-2.5">
                <FaLocationDot className="text-emerald-400 text-sm mt-0.5 shrink-0" />
              ...
              <div className="flex items-center gap-2.5">
                <FaPhone className="text-emerald-400 text-sm shrink-0" />
                <a href="tel:09611996677" className="hover:text-white text-sm transition-colors">
                  09611996677
                </a>
              </div>
            </div>

            {/* Social Media Links in Upper Section */}
            <div className="pt-2 flex items-center gap-2">
              <span className="text-xs text-emerald-200/70 font-medium mr-1">Follow Us:</span>
              <Link
                href="#"
                aria-label="Facebook"
                className="w-8 h-8 rounded-full bg-emerald-950/80 border border-emerald-900/60 hover:bg-[#006a52] hover:text-white hover:border-emerald-500 text-slate-300 flex items-center justify-center transition-all"
              >
          ...
          {/* Column 2: Quick Shop */}
          <div>
            <h4 className="text-sm font-medium text-white uppercase tracking-wider mb-4 pb-1 border-b border-emerald-900/60 inline-block">
              Quick Shop
            </h4>
            <ul className="space-y-2 text-sm text-emerald-100/70 font-medium">
              <li>
              ...
              <li>
                <Link href="#" className="hover:text-emerald-300 flex items-center gap-1.5 transition-all group">
                  <FaChevronRight className="text-[9px] text-emerald-500/60 group-hover:text-emerald-300" />
                  <span>Fresh Fruits & Produce</span>
                </Link>
              </li>
              <li>
                <Link href="#" className="hover:text-emerald-300 flex items-center gap-1.5 transition-all group">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-emerald-100/70 font-medium">
              ...
              <li>
                <Link href="#" className="hover:text-emerald-300 flex items-center gap-1.5 transition-all group">
                  <FaChevronRight className="text-[9px] text-emerald-500/60 group-hover:text-emerald-300" />
                  <span>Become a Partner / Supplier</span>
                </Link>
              </li>
              <li>
                <Link href="#" className="hover:text-emerald-300 flex items-center gap-1.5 transition-all group">
        ...
        {/* Bottom Bar: Left Copyright & Right Developer Credit */}
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-emerald-100/60 font-medium">
